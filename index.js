...
//promises
//433f52f2a65341b4a77477d2997f6ef5
//https://api.geoapify.com/v1/ipinfo?apiKey=YOUR_API_KEY

async function getCountryByIp() {
    try{
        const apiKey ='433f52f2a65341b4a77477d2997f6ef5';
        const ipUrl = `https://api.geoapify.com/v1/ipinfo?apiKey=YOUR_API_KEY=${apiKey}`;
        ...
        const optionToSelect = [...inputCountries.children].find(option =>{
            if (option.getAttribute('data-countryCode') === isoCode){
                return option
            }
        });
        ...
        console.log(error);
        alert(`sucedido un error! ${error.message}`)
    }
}
